...
int main() {
    try {
        int64_t upper_limit = 1000000;
        int64_t result = func::circular_primes_less_than(upper_limit);
        std::cout << "The number of circular primes less than " << upper_limit << " is: " << result << '\n';
